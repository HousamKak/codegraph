    ...
    >
      ...
      <div className="p-3 border-b border-border">
        ...
        <button
          ...
          className={`w-full py-1.5 px-3 rounded text-xs font-medium transition-colors flex items-center justify-center gap-2 ${
            compareMode
      ...
      <div className="flex-1 overflow-y-auto">
        {commits.length === 0 ? (
          <div className="p-4 text-center text-text-secondary text-sm">
            ...
            <p className="mt-2 text-xs">Initialize a git repository to track history.</p>
          </div>
        ) : (
          <div className="py-2">
